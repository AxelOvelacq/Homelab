# Generated by Powerlevel10k configuration wizard on 2024-04-14 at 13:34 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49778.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, flat heads, flat tails, 2 lines, dotted, left frame,
...
#  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=232
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=8 #0

  # # Context color in SSH without privileges.
  # typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=7 #3
  # typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=8 #0
  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=15
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=196 #0
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=7 #3
